...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("bitcoinold-ext-ip");
...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Bitcoinold " + FormatFullVersion();
...
unsigned int pnSeed[] =
{
    0x12db7edf, 0x12db99c3, 0xb070d46e
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Bitcoinold is probably already running."), addrBind.ToString().c_str());
        else
...
{
    printf("StopNode()\n");
    GenerateBitcoinolds(false, NULL);
    MapPort(false);
