...
WORKINGDIR="/tmp/bitcoinold"
TMPFILE="hashes.tmp"

#this URL is used if a version number is not specified as an argument to the script
SIGNATUREFILE="http://downloads.sourceforge.net/project/bitcoinold/Bitcoinold/bitcoinold-0.8.6/SHA256SUMS.asc"

SIGNATUREFILENAME="SHA256SUMS.asc"
RCSUBDIR="test/"
BASEDIR="http://downloads.sourceforge.net/project/bitcoinold/Bitcoinold/"
VERSIONPREFIX="bitcoinold-"
RCVERSIONSTRING="rc"
...
if [ $? -ne 0 ]; then
   ...
   echo "[bitcoinold-]<version>-[rc[0-9]] (example: bitcoinold-0.7.1-rc1)"
   echo "wget output:"
